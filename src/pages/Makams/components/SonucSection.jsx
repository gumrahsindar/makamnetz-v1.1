...
export default function SonucSection({ selectedMakam }) {
  return (
    <Stack className='h-[34rem] space-y-6 rounded-md bg-gradient-to-r from-red-100 to-red-300 px-14 py-4 text-center lg:w-3/12 lg:py-12'>
      <Text className='mb-20 rounded-md bg-gradient-to-b from-red-200 to-red-600 px-10 py-2 text-xl font-bold text-white shadow-xl'>
        Karar
      </Text>
