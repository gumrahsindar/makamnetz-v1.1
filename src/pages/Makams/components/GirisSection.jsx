...
export default function GirisSection({ selectedMakam }) {
  return (
    <Stack className='h-[34rem] justify-around space-y-6 rounded-md bg-gradient-to-r from-blue-100 to-blue-300 px-4 py-4 text-center lg:w-[300px] lg:py-12 xl:px-8'>
        ...
        {Array(4)
          ...
          .map((_, i) => {
            ...
            return root ? (
              ...
              >
                <Text className='px-2 text-lg text-white'>
                  {root}
